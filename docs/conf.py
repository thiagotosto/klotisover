# -*- coding: utf-8 -*-
#
# Klotisover documentation build configuration file, created by
...
htmlhelp_basename = 'Klotisoverdoc'
...
man_pages = [
    (master_doc, 'klotisover', u'Klotisover',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Klotisover', u'Klotisover',
     author, 'Klotisover', 'One line description of project.',
     'Miscellaneous'),
]
